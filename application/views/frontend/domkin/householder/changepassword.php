               ...
               <div id="registration_form">
                 <div class="form-group" style="margin-bottom:30px;">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="password" class="form-control" name="oldpassword" value="<?php echo set_value('oldpassword'); ?>" id="disabledinput" placeholder="Old Password"  style="width:100%; padding:6px"/>
                      <?php echo form_error('oldpassword','<p class="label label-danger">','</p>'); ?>
                    </div>
          		  </div>
                  <div class="form-group">
                    <label class="control-label col-sm-4" style=" margin-right:20px">New Password</label>
                    <div class="col-sm-7">
                      <input type="password" class="form-control" name="newPass" value="<?php echo set_value('password'); ?>" id="disabledinput" placeholder="Password"  style="width:100%; padding:6px"/>
                ...
                <div class="col-sm-7">
                  <input type="password" class="form-control" style="margin:0px 0 10px 0;width:100%; padding:6px"  name="confirmpassword" value="<?php echo set_value('confirmpassword'); ?>" placeholder="xxxxx"><?php echo form_error('confirmpassword','<p class="label label-danger">','</p>'); ?>
                </div>
            </div>
