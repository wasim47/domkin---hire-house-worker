            	...
            	<div  style="margin:0 10px;">
                    <table class="table" width="100%">
                        ...
                        <tr>
                            ...
                            <th width="1%">:</th>
                            <th width="73%">
							<img src="<?php echo base_url('asset/uploads/domkin/staff/'.$staffdetails['s_photo']);?>" alt="<?php echo $staffdetails['s_name'];?>" title="<?php echo $staffdetails['s_name'];?>" style="width:150px; height:150px"></th>
                   	  </tr>   
                        <tr>
