...
<div class="header_img1">
   ...
   <?php echo form_open_multipart('domkin/householder_action', array('class'=>'form-horizontal','name'=>'form1','id'=>'form1')); ?>
               ...
               <div id="registration_form" style="margin:0 10px;">
               	<div><?php echo $this->session->flashdata('successMsg');?></div>
                    ...
                    <div class="form-group">        
                        <label class="control-label col-sm-4" style=" margin-right:20px">House Hold Name <span style="color:#ff0000">*</span></label>
                        <div class="col-sm-7">
                          <input name="householdername" type="text"  class="form-control" style="border:1px solid #ccc;"  required="required" value="<?php echo $userProfile['hh_name'];?>" placeholder="Staff Name"/>
                        <?php echo form_error('householdername', '<p style="color:#ff0000;margin:0;">','</p>'); ?>
                        </div>
                    </div>
                    <div class="form-group">        
                        <label class="control-label col-sm-4" style=" margin-right:20px">Father's Name</label>
                        <div class="col-sm-7">
                          <input name="fname" id="fname" type="text"  style="border:1px solid #ccc;" class="form-control" value="<?php echo $userProfile['hh_fathers_name'];?>" placeholder="Father`s Name"/>
                   </div>
                    </div>
                    <div class="form-group">       
                        <label class="control-label col-sm-4" style=" margin-right:20px">Mother's Name</label>
                        <div class="col-sm-7">
                          <input name="mname" id="mname" type="text"  style="border:1px solid #ccc;" class="form-control" required="required" value="<?php echo $userProfile['hh_mothers_name'];?>" placeholder="Mother`s Name"/>
                   </div>
                    </div>
                    <div class="form-group">       
                        <label class="control-label col-sm-4" style=" margin-right:20px">Spouse Name </label>
                        <div class="col-sm-7">
                          <input name="spousename" id="spousename" type="text"  style="border:1px solid #ccc;" class="form-control" value="<?php echo $userProfile['hh_spouse_name'];?>" placeholder="Spouse Name"/>
                   </div>
                    </div>
                    
                    <?php $dob = $userProfile['hh_date_of_birth'];
                    ...
                    <div class="form-group">       
                        ...
                        <div class="col-sm-7">
                        <?php $gender = $userProfile['hh_gender'];?>
                    ...
                    <div class="form-group">       
                        ...
                        <div class="col-sm-7">
                          <input name="nationality" id="nationality" type="text"  style="border:1px solid #ccc;" class="form-control" value="<?php echo $userProfile['hh_origin'];?>" placeholder="Natinality/Origin "/>
                   </div>
                    </div>
                    <div class="form-group">       
                        <label class="control-label col-sm-4" style=" margin-right:20px">National ID/Passport <span style="color:#ff0000">*</span></label>
                        <div class="col-sm-7">
                          <input name="nidpass" id="nidpass" type="text"  style="border:1px solid #ccc;" class="form-control"  required="required" value="<?php echo $userProfile['hh_nidPassport'];?>" placeholder="National ID/Passport"/>
                    ...
                    <div class="form-group">        
                        ...
                        <div class="col-sm-7">
                           <input name="mobile" id="mobile" type="text" style="border:1px solid #ccc;" class="form-control" required="required" value="<?php echo $userProfile['hh_phone_no'];?>" placeholder="Mobile No."/>
                    ...
                    <div class="form-group">        
                        ...
                        <div class="col-sm-7">
                           <textarea name="pre_address" rows="6" cols="40"  style="border:1px solid #ccc;" class="form-control" placeholder="Present Address"><?php echo $userProfile['hh_pre_address'];?></textarea>
                    </div>
                    </div>
                   <div class="form-group">        
                        <label class="control-label col-sm-4" style=" margin-right:20px">Permanent Address</label>
                        <div class="col-sm-7">
                           <textarea name="per_address" rows="6" cols="40"  style="border:1px solid #ccc;" class="form-control" placeholder="Permanent Address"><?php echo $userProfile['hh_per_address'];?></textarea>
                    </div>
                   </div>
                   ...
                   <div class="form-group">        
                        ...
                        <div class="col-sm-7">
                      <input name="householderimg" id="householderimg" type="file"  class="form-control"  style="border:1px solid #ccc;"/>
                      <img src="<?php echo base_url('asset/uploads/domkin/householder/'.$userProfile['hh_photo']);?>" style="width:150px; height:auto;border:1px solid #ccc; margin:5px" />
                    </div>
                    ...
                    <div class="form-group">        
                      ...
                      <input name="email" id="email" type="email"  class="form-control"  required="required"  style="border:1px solid #ccc;"
                                            value="<?php echo $userProfile['hh_email'];?>" placeholder="Email Address"/>
                ...
                <div class="col-md-5 col-md-offset-5" style="margin-bottom:20px">        
               		 <input type="hidden" name="hh_id" value="<?php echo $id;?>">
                    <input type="hidden" name="stillimg" value="<?php echo $userProfile['hh_photo'];?>">
