   ...
   <?php echo form_open_multipart('', array('class'=>'form-horizontal','name'=>'form1','id'=>'form1')); ?>
               <div id="registration_form">
                ...
                <div class="form-group">        
                    <label class="control-label col-sm-4" style=" margin-right:20px"> Name <span style="color:#ff0000">*</span></label>
                    <div class="col-sm-7">
                      <input name="staffname" type="text"  class="form-control"  required="required" value="<?php echo set_value('memberName'); ?>" placeholder="Name"/>
