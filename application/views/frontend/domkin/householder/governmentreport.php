...
<div class="header_img1">
        <div class="container">
           ...
           <div class="col-sm-2">
           	...
           	<div class="col-sm-12 col-md-7"><a href="<?php echo base_url('domkin/householder_profile/government_report_action');?>" class="btn btn-success btn-sm" style="float:right; margin:0 10px 10px 0;" title="Add New Report"> <span class="glyphicon glyphicon-plus-sign"></span> </a></div>
                    ...
                    ?>
                     <tr>
                        ...
                        <td><?php echo $ps_status; ?></td>
                         ...
                         <a href="<?php echo base_url('domkin/householder_profile/government_report_action/'.$ps_id);?>" class="btn btn-info btn-sm">
